...
import { Directive, DirectiveTargetElement, FieldDefinition, Schema, SchemaRootKind, VariableCollector, VariableDefinitions, CompositeType, DeferDirectiveArgs, Variable, Type, Variables, NamedType } from "@apollo/federation-internals/src/definitions";
import { MultiMap, SetMultiMap } from "@apollo/federation-internals/src/utils";
