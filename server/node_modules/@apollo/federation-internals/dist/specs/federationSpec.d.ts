import { FeatureDefinition, FeatureDefinitions, FeatureVersion } from "@apollo/federation-internals/src/specs/coreSpec";
...
export declare const FEDERATION1_TYPES: import("@apollo/federation-internals/src/directiveAndTypeSpecification").TypeSpecification[];
export declare const FEDERATION1_DIRECTIVES: import("@apollo/federation-internals/src/directiveAndTypeSpecification").DirectiveSpecification[];
